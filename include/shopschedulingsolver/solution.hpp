...
public:
    ...
    struct Job
    {
        ...
        OperationId number_of_operations = 0;
    ...
    JobId number_of_operations() const { return this->number_of_operations_; }
    ...
    bool contains(JobId job_id, OperationId operation_id) const { return this->job(job_id).operations[operation_id].machine_id != -1; }
